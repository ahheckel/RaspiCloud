...
<xsl:include href="get-file-extension.xsl"/>    
    ...
    <html>
    <!-- ENTRY03 -->
    <link href="/.cloud02/.custom.css" rel="stylesheet" type="text/css" media="all"/>
        <body>  
        <head>
            <meta name="viewport" content="width=device-width, initial-scale=0.1" />
            <script src="/.cloud02/.yall.min.js"></script>
        </head>
            ...
            <td> 
                <div id="dropdown" style="float:right;">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="/.cloud02/User1/tmp">Cloud User1</a>
                        <a href="/.cloud02/User2/tmp">Cloud User2</a>
                        <a href="/.cloud02/User3/tmp">Cloud user3</a>
                        <p style="border-bottom: 4px solid #aa0"></p>
                        <a href="/.cloud02/.gps">GPS</a>                        
                    </div>
                </div> 
            </td>
        </tr>        
        ...
        <tr class="black">
            <td id="searchclear"><img src="/.cloud02/.icons/searchcancel.png"/></td>
        ...
        <tr class="head">
            ...
            <!-- ENTRY01 -->
            <td class="header" align="left"><a class="high3" href="/.cloud02/" id="sortname" style="color:#fff">Name</a></td>
            <td class="header" align="left"><a class="high3" href="/.cloud02/" id="sortsize">Size</a></td>
            <td class="header" align="left"><a class="high3" href="/.cloud02/" id="sortdate">Date</a></td>
        </tr>
        <script src="/.cloud02/.jquery.min.js"></script>
        <!-- ENTRY04 -->
        <script src="/.cloud02/.custom.js"></script>
        
        <!-- DIR LISTING -->
        <td class="icon"><a href="#"><img class="icon" src="/.cloud02/.icons/folder-home.png"/></a></td>
        ...
        <xsl:for-each select="list/directory">
            ...
            <tr> 
                <td class="icon"><a href="#"><img class="icon" src="/.cloud02/.icons/folder-remote.png"/></a></td>
        ...
        <tr class="row">            
            ...
            <td class="icon"><a href="#"><img class="icon" src="/.cloud02/.icons/{$ext}.png" alt="." /></a></td>
