...
<xsl:include href="get-file-extension.xsl"/>    
    ...
    <link href="/.cloud02/.custom.css" rel="stylesheet" type="text/css" media="all"/>
        ...
        <tr class="head">
            ...
            <!-- ENTRY01 -->
            <td class="header" align="left"><a class="high3" href="/.cloud02/" id="sortname">Name</a></td>
            <td class="header" align="left"><a class="high3" href="/.cloud02/" id="sortsize" style="color:#fff">Size</a></td>
